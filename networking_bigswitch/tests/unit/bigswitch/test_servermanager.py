...
class ServerManagerTests(test_rp.BigSwitchProxyPluginV2TestCase):
    ...
    def test_get_unicode_status(self):
        """Verify that unicode is enabled only when:
        ...
        capability_func = 'networking_bigswitch.plugins.bigswitch' \
                          '.servermanager.' \
                          'ServerPool.get_capabilities'

...
HTTPCON = ('networking_bigswitch.plugins.bigswitch.servermanager.httplib'
           '.HTTPConnection')
GET_UNICODE_STATUS = ('networking_bigswitch.plugins.bigswitch.servermanager.'
                      'ServerPool.get_unicode_status')
...
class TestDisplayName(BigSwitchProxyPluginV2TestCase):
    ...
    def test_map_display_name_or_tenant_unicode_disabled(self):
        ...
        self.assertFalse(plugin_obj.servers.get_unicode_status())
    ...
    def test_map_display_name_or_tenant_unicode_enabled(self):
        ...
        """
        self.map_display_name_or_tenant_p.stop()
        self.get_unicode_status_p.stop()
        mock.patch(GET_UNICODE_STATUS, side_effect=self.get_true).start()
        plugin_obj = directory.get_plugin()

        self.assertTrue(plugin_obj.servers.get_unicode_status())

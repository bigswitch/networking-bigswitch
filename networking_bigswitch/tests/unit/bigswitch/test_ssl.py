...
from networking_bigswitch.tests.unit.bigswitch.mock_paths import SSL_GET_CERT
...
class test_ssl_certificate_base(test_plugin.NeutronDbPluginV2TestCase,
    ...
    def _setUp(self):
        ...
        self.sslgetcert_m = mock.patch(SSL_GET_CERT, create=True).start()

...
# Agent
AGENTMOD = BSN_DIR + '.agent.restproxy_agent'
...
SERVER_REST_ACTION = SERVER_POOL+'.rest_action'
BACKGROUND = SERVER_POOL + '.start_background_tasks'
SERVER_TOPO_SYNC = SERVER_POOL + '.force_topo_sync'
SERVER_UPDATE_TENANT_CACHE = SERVER_POOL + '._update_tenant_cache'
SERVER_GET_CAPABILITIES = SERVER_POOL + '.get_capabilities'
IS_UNICODE_ENABLED = SERVER_POOL + '.is_unicode_enabled'

# SSL Cert Related
SSL_GET_CERT = SERVER_MANAGER + '.ssl.get_server_certificate'

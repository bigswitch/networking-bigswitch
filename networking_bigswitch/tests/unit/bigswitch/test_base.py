...
L3_RESTPROXY_PKG_PATH = 'networking_bigswitch.plugins.bigswitch.l3_router_plugin'
...
CERTFETCH = 'networking_bigswitch.plugins.bigswitch.servermanager.ServerPool._fetch_cert'  # noqa
...
SPAWN = 'networking_bigswitch.plugins.bigswitch.plugin.eventlet.GreenPool.spawn_n'

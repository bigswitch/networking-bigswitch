...
MIN_LOCK_RETRY_SLEEP_TIME_SECS = 20
MAX_LOCK_RETRY_SLEEP_TIME_SECS = 120
...
class HashHandler(object):
        ...
        if time_diff < TOPO_SYNC_EXPIRED_SECS:
            ...
            LOG.debug("TOPO_SYNC: NOT EXPIRED. "
                      ...
                      {'prev': prev_ts,
                       ...
                       'curr': self.lock_ts,
                       'curr_dt_string': convert_ts_to_datetime(curr_ts_float),
                       'diff': time_diff,
    ...
    def put_hash(self, hash):
        ...
        LOG.debug("TOPO_SYNC: Consistency timestamp updated to %(hash_ts)s "
                  "by LockID %(this)s",
                  {'hash_ts': hash, 'this': self.lock_ts})

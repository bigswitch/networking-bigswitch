...
class BigSwitchMechanismDriver(plugin.NeutronRestProxyV2Base,
    ...
    def setup_sg_rpc_callbacks(self):
        ...
        keystone_target = oslo.messaging.Target(
             topic='notifications', exchange='keystone', server=cfg.CONF.host)
        # nova_target = oslo.messaging.Target(
        #     topic='notifications', exchange='nova', server=cfg.CONF.host)
        self.listener = oslo.messaging.get_notification_listener(

...
class ServerProxy(object):
    ...
    def rest_call(self, action, resource, data='', headers=None,
        ...
        # TODO: Re-enable keep-alive in a thread-safe fashion. When multiple
        # workers are enabled the saved connection gets mangled by multiple
        # threads so we always reconnect.

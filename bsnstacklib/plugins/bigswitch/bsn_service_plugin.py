...
class BSNServicePlugin(service_base.ServicePluginBase,
    ...
    def create_networktemplate(self, context, networktemplate):
        ...
        with context.session.begin(subtransactions=True):
            networktemplate = \
                NetworkTemplate(tenant_id=networktemplate_data['tenant_id'],
                                body=networktemplate_data['body'],
    ...
    def create_reachabilitytest(self, context, reachabilitytest):
        ...
        with context.session.begin(subtransactions=True):
            reachabilitytest = ReachabilityTest(
                ...
                src_tenant_id=reachabilitytest_data['src_tenant_id'],
                src_segment_id=reachabilitytest_data['src_segment_id'],
    ...
    def create_reachabilityquicktest(self, context, reachabilityquicktest):
        ...
        with context.session.begin(subtransactions=True):
            reachabilityquicktest = ReachabilityQuickTest(
                id=reachabilityquicktest_data['tenant_id'],
                tenant_id=reachabilityquicktest_data['tenant_id'],
                name=reachabilityquicktest_data['name'],
                src_tenant_id=reachabilityquicktest_data['src_tenant_id'],
                src_segment_id=reachabilityquicktest_data['src_segment_id'],
                src_ip=reachabilityquicktest_data['src_ip'],
                dst_ip=reachabilityquicktest_data['dst_ip'],
                expected_result=reachabilityquicktest_data['expected_result'])
